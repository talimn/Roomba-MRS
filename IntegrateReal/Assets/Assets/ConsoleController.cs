...
public class ConsoleController
{
	...
	// Reload will restart simulation and send Roombas back to initialization point
	// Location will return 3D coordinates

	// Type 'help' for more information on command handlers
