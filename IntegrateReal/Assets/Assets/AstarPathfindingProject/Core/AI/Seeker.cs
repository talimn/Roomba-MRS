...
namespace Pathfinding {
	...
	public class Seeker : VersionedMonoBehaviour {
        /// Draws last calculated path using Gizmos in green
        ...
        /// tags which Seeker can travel, field is bitmask
		[HideInInspector]
		public int traversableTags = -1;

        /// penalties for each tag
        /// default tag is Tag 0, will have added a penalty of tagPenalties[0]
        /// array should have length of 32
		[HideInInspector]
